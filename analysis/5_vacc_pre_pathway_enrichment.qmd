...
-   Pros and Cons:
    ...
    -   For example, the top 10 pathways of H107_CAF09c immu1_vs_pre are:
        ...
        -   "GOBP_TYPE_I\_INTERFERON_PRODUCTION"
        -   "GOBP_RESPONSE_TO_VIRUS"
        -   "GOBP_REGULATION_OF_VIRAL_PROCESS"
        -   "GOBP_RESPONSE_TO_TYPE_I\_INTERFERON"
        -   "GOBP_POSITIVE_REGULATION_OF_TYPE_I\_INTERFERON_PRODUCTION"
...
t_bubble <- 
  ...
  mutate(`-log10 P-value` = -log10(padj),
         contrast = case_when(
           ...
           contrast == "immu1_vs_pre" ~ "immu. 1",
           contrast == "immu2_vs_pre" ~ "immu. 2"
         ),
         vacc = case_when(
...
ggsave("../data/figure/gsea_bubble_narrow.png", g_bubble, 
       height = 6, width = 6, dpi = 1000)

ggsave("../data/figure/gsea_bubble_medium.png", g_bubble, 
       height = 6, width = 7, dpi = 1000)

ggsave("../data/figure/gsea_bubble_wide.png", g_bubble, 
       height = 6, width = 8, dpi = 1000)
```

## Bubble plot

![](images/gsea_bubble.png){fig-align="center"}
