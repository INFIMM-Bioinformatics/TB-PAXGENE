...
>>>>>>> 03bfb57f186bfba69f202d0523f3868e76c30792
```
...
# label_facet <- 
#   as_labeller(
#     c(H107_CAF04_CpG = "CAF10b", H107_CAF09c = "CAF09^hi"), 
#     default = label_parsed
# )
# 
# label_facet_y <- 
#   as_labeller(
#     t_bubble$theme %>% unique
#   )
...
```{r}
ggsave("../data/figure/gsea_bubble.png", g_bubble, height = 6.2, width = 8, dpi = 600)
```
