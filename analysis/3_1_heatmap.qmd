...
library(seriation)
o = seriate(dist(filtered_count), method = "GW")
...
elements_to_exclude <- c("SLC47A1", "ORM1", "KIT", "NRN1", "CPED1", "LRRN1", "SCAMP4", "MRC2", "LIMA1")

# Filtering elements not matching the exclusion list
filtered_count <- count[!(rownames(count) %in% elements_to_exclude), ]
